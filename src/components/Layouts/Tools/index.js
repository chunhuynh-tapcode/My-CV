  ...
  return (
    <div className={cx("tools")}>
      ...
      <animated.ul
        ...
        className={cx("tools-list")}
      >
        <li className={cx("tools-item")} alt="HTML5">
          <svg
            className={cx("icon")}
            role="img"
            viewBox="0 0 24 24"
        ...
        <li className={cx("tools-item")} alt="CSS">
          <svg
            className={cx("icon")}
            role="img"
            viewBox="0 0 24 24"
        ...
        <li className={cx("tools-item")} alt="JavaScript">
          <svg
            className={cx("icon")}
            role="img"
            viewBox="0 0 24 24"
        ...
        <li className={cx("tools-item")} alt="ReactJS">
          <svg
            className={cx("icon")}
            role="img"
            viewBox="0 0 24 24"
        ...
        <li className={cx("tools-item")} alt="Figma">
          <svg
            className={cx("icon")}
            role="img"
            viewBox="0 0 24 24"
